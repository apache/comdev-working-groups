...
as an Apache project and that the project is recognized as part of the Apache Software Foundation.

The software that ASF projects produce is released under the Apache License, Version 2.0, which is a permissive
open source license that allows the software to be used by anyone for any purpose and it is important that
we do not limit anyone from using the software in any way. And while we allow anyone to use the software,
and redistribute it, we do not allow anyone to claim that they are the "owners" of the software, or that
